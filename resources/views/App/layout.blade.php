...
<html class="no-js" lang="en">
    <head>
        <title>CWZ | Free Online Courses</title>
        <meta charset="utf-8">
                ...
                <div class="container-fluid nav-header-container">
                    <div class="col-auto col-sm-6 col-lg-2 me-auto ps-lg-0">
                        <a class="navbar-brand" href="#">
                            ...
                            <img src="{{asset('logo2.jpeg')}}" data-at2x="app/images/logo-white@2x.png" class="default-logo" alt="">
                            <img src="{{asset('logo2.jpeg')}}" data-at2x="app/images/logo-green-dark@2x.png" class="alt-logo" alt="">
                            <img src="{{asset('logo2.jpeg')}}" data-at2x="app/images/logo-green-dark@2x.png" class="mobile-logo" alt="">
                        </a>
                    </div>
                    <div class="col-auto col-lg-8 menu-order px-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                            <ul class="navbar-nav alt-font">
                                ...
                                <li class="nav-item dropdown megamenu">
                                    <a href="{{url('about-me')}}" class="nav-link">About Me</a>
                                    <i class="fa fa-angle-down dropdown-toggle" data-bs-toggle="dropdown" aria-hidden="true"></i>
                                </li>

                                <li class="nav-item dropdown megamenu">
                                    <a href="{{url('lectures')}}" class="nav-link">Video Lectures</a>
                                    <i class="fa fa-angle-down dropdown-toggle" data-bs-toggle="dropdown" aria-hidden="true"></i>
                                </li>
                                ...
                                <li class="nav-item dropdown simple-dropdown">
                                    <a href="#" class="nav-link">Want To Learn</a>
                                    <i class="fa fa-angle-down dropdown-toggle" data-bs-toggle="dropdown" aria-hidden="true"></i>
                                    <ul class="dropdown-menu" role="menu">
                                        @if(!empty($languages))
                                        @foreach($languages as $language)
                                        <li class="dropdown">
                                            <a href="{{url('tutorial',$language->id)}}" style="text-transform: uppercase">{{$language->language_name}}<i class="dropdown-toggle"></i></a>
                                        </li>
                                        @endforeach
                                        @endif
                                        <!-- <li class="dropdown">
                                ...
                                <li class="nav-item dropdown megamenu">
                                    <a href="{{url('pdf-courses')}}" class="nav-link">PDF Courses</a>
                                    <i class="fa fa-angle-down dropdown-toggle" data-bs-toggle="dropdown" aria-hidden="true"></i>
                                </li>
