...
<div class="px-6 py-4">
<div class="font-bold text-xl mb-2">This is tile</div>
<p class="text-gray-700 text-base">
{{ Str::words("Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
