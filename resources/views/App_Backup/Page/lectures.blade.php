                            ...
                            <li class="grid-item fashion wow animate__fadeIn">
                                <div class="blog-post text-center border-radius-6px bg-white box-shadow box-shadow-large-hover">
                                    <div class="blog-post-image bg-gradient-fast-blue-purple">
                                        ...
                                        <a href="{{url('lecture-detail',$lecture->id)}}"><img src="public\theme\img\LectureThumbnail\{{$lecture->thumbnail}}" alt="">
                                    ...
                                    <div class="post-details padding-30px-all xl-padding-25px-lr">
                                        <a href="{{url('lecture-detail',$lecture->id)}}" class="post-author text-medium text-uppercase">{{$lecture['language']->language_name}}</a>
                                        <a class="text-extra-dark-gray font-weight-500 d-block" style="height:50px">{{$lecture->title}}</a>
                                    </div>
                                </div>
                            </li>
                            @endforeach
